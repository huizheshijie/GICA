...
<block name="body">
		 <!-- 引用头部公共部分  --><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="nymain">
			<div class="wdzh">
				<div class="l_nav">
...
<!-- 		<li id="li_3">
			<a href="<?php echo U('Userinfo/userbankInfo');?>">融资认证</a>
		</li> -->
		<!--
		<li id="li_5">
			<a href="updatexgmm.htm">安全设置</a>
		</li>-->
<!-- <li id="li_121"><a href="<?php echo U('Userinfo/userbankset');?>">安全中心</a></li>
		<li id="li_2">
			<a href="<?php echo U('Userinfo/userbasicdata');?>">充值提现</a>
		</li>
		<li id="li_4">
			<a href="<?php echo U('Userinfo/userbasicinfo');?>">站内信</a>
		</li>
		<li id="li_6">
			<a href="<?php echo U('Userinfo/userchagerwithdraw');?>">好友管理</a>
		</li>
<li id="li_123"><a href="<?php echo U('Userinfo/userchangebankInfo');?>">通知设置</a></li> -->
	</ul>
</div>
<!-- <div class="box">
	<div class="til">
	...
	<ul>
		<li id="li_7" class="fir">
			<a href="<?php echo U('Userinfo/userchangepass');?>">还款管理</a>
		</li>
		<li id="li_8">
			<a href="<?php echo U('Userinfo/userchangephone');?>">已发布的借款</a>
		</li>
		<li id="li_9">
			<a href="<?php echo U('Userinfo/userfinanceindex');?>">贷款统计</a>
		</li>
	</ul>
</div> -->
<!-- <div class="box">
	...
	<ul>
		<li id="li_10">
			<a href="<?php echo U('Userinfo/userfindpass');?>">我的投标</a>
		</li>
		<li id="li_11">
			<a href="<?php echo U('Userinfo/userfindpassbyphone');?>">我关注的借款</a>
		</li>
		<li id="li_12">
			<a href="<?php echo U('Userinfo/userfindpaypass');?>">理财统计</a>
		</li>
		<li id="li_13"><a href="automaticBidInit.htm">自动投标</a></li>
	</ul>
</div> -->
<!--
      <div class="box">
      ...
      <ul><li id="li_14"><a href="queryCanAssignmentDebt.htm">债权转让</a></li>
			<li id="li_15"><a href="queryBuyingDebt.htm">债权竞拍</a></li>
</ul>
</div>-->
					...
					<div class="box box2" style="border-bottom: none;">
						...
						<div class="box-main">
							<div style="overflow: hidden; ">
								<div class="pic_info">
									<div class="pic">
											<img src="/Public/static/rzg_images/default-img.jpg" width="128" height="128">
									</div>
									<p><form action="<?php echo U('updateFile');?>" enctype="multipart/form-data" method="post">
										<a href="javascript:void(0);" id="test2">更换头像</a><!-- <input type="file"  name="file[]"><input  type="submit"  value="上传"> -->
										</form>
									</p>
								</div>
								<div class="xx_info">
...
<!-- 										<tr>
								...
								<div class="hy_info">
									<?php if($vo["status"] == 1): ?><a href="renewalVIPInit.htm" class="vipbtn" target="_self">会员续费</a>
									<?php elseif($vo["status"] == 0): ?>
										<a href="bevip.htm" class="vipbtn" target="_self">成为会员</a><?php endif; ?>
									...
									<table>
										<tr>
											<th align="right">
											 ...
											 <!-- 邮箱认证 -->
											<td>
													<a href="emailManagerInit.htm"><img
											...
											<td>
											 ...
											 <!-- 手机认证 -->
											<td>
													<a href="owerInformationInit.htm"><img
											...
											<td>
											 ...
											 <!-- 身份证认证  -->
											<td>
												<a href="owerInformationInit.htm">
							...
							<div class="tips" style="width: 90%; margin: 0 auto">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td>
											未读站内信
											<a href="mailNoticeInit.htm" target="_self">（<s:if
													test="#request.homeMap.unReadCount !=''"><?php echo ($vo["money_collect"]); ?></s:if>
												<s:else>0</s:else>）</a>封
										</td>
										<td>
											等待审核借款
											<a href="homeBorrowAuditList.htm" target="_self">（<s:if
													test="#request.homeMap.waitBorrowCount !=''"><?php echo ($vo["money_collect"]); ?></s:if>
												<s:else>0</s:else>）</a>个
										</td>
										<td>
											本月待还款
											<a href="queryMyPayingBorrowList.htm" target="_self">（<s:if
													test="#request.homeMap.repayCount !=''"><?php echo ($vo["money_collect"]); ?></s:if>
												<s:else>0</s:else>）</a>个
										</td>
										<td>
											本月待收款
											<a href="homeBorrowRecycleList.htm" target="_self">（<s:if
													test="#request.homeMap.forpayCount !=''"><?php echo ($vo["money_collect"]); ?></s:if>
												<s:else>0</s:else>）</a>个
										</td>
									</tr>
									<tr>
										<td>
											逾期待还款
											<a href="queryMyPayingBorrowList.htm" target="_self">（<s:if
													test="#request.homeMap.lateRepayCount !=''"><?php echo ($vo["money_collect"]); ?></s:if>
												<s:else>0</s:else>）</a>个
										</td>
										<td>
											上传资料
					...
					<div class="box" style="border-bottom: none;">
						<div class="box-main" style="padding-left: 70px;">
							<div class="mid">
								<ul>
									<li>
										<a href="rechargeInit.htm" target="_self"><img
												src="/Public/static/rzg_images/022713_32.jpg" width="32" height="35" /> </a>
										<br />
										<a href="rechargeInit.htm" target="_self">我要充值</a>
									</li>
									<li>
										<a href="withdrawLoad.htm" target="_self"><img
												src="/Public/static/rzg_images/ti_34.jpg" width="32" height="35" /> </a>
										<br />
										<a href="withdrawLoad.htm" target="_self">我要提现</a>
									</li>
									<li>
										<a href="finance.htm" target="_self"><img
												src="/Public/static/rzg_images/022713_36.jpg" width="32" height="35" /> </a>
										<br />
										<a href="finance.htm" target="_self">我要理财</a>
									</li>
									
									<li>
										<a href="queryMyPayingBorrowList.htm"><img
												src="/Public/static/rzg_images/022713_38.jpg" width="32" height="35" /> </a>
										<br />
										<a href="queryMyPayingBorrowList.htm">我要还款</a>
									</li>
									<li>
										<a href="homeBorrowRecycleList.htm" target="_self"><img
												src="/Public/static/rzg_images/022713_40.jpg" width="32" height="35" /> </a>
										<br />
										<a href="homeBorrowRecycleList.htm" target="_self">待收款</a>
									</li>
									<li>
										<a href="queryFundrecordInit.htm"><img
												src="/Public/static/rzg_images/022713_42.jpg" width="32" height="35" /> </a>
										<br />
										<a href="queryFundrecordInit.htm">资金流水</a>
									</li>
									<li>
										<a href="borrowapply.htm" target="_self"><img
												src="/Public/static/rzg_images/022713_44.jpg" width="32" height="35" /> </a>
										<br />
										<a href="borrowapply.htm" target="_self">我要借款</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="box-main">
							<table border="0" cellpadding="0" cellspacing="0" class="zhtab">
								...
								<tr>
									<td>
										账户总额：￥
										<s:if test="#request.accmountStatisMap.accountSum !=''"><?php echo ($vo["account_money"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										可用余额：￥
										<s:if test="#request.accmountStatisMap.usableAmount !=''"><?php echo ($vo["account_money"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										冻结金额：￥
										<s:if test="#request.accmountStatisMap.freezeAmount !=''"><?php echo ($vo["money_freeze"]); ?></s:if>
										<s:else>0</s:else>
									</td>
								</tr>
								<tr>
									<td>
										总收益：￥
										<s:if test="#request.accmountStatisMap.earnSum !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										利息收益：￥
										<s:if test="#request.accmountStatisMap.rateEarnAmount !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										其他收益：￥
										<s:if test="#request.accmountStatisMap.otherEarnAmount !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										已收总额：￥
										<s:if test="#request.accmountStatisMap.hasPaySum !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										已收本金：￥
										<s:if test="#request.accmountStatisMap.hasPayPrincipal !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										已收利息：￥
										<s:if test="#request.accmountStatisMap.hasPayInterest !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
								</tr>
								<tr>
									<td>
										待收总额：￥
										<s:if test="#request.accmountStatisMap.forPaySum !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										待收本金：￥
										<s:if test="#request.accmountStatisMap.forPayPrincipal !=''"><?php echo ($vo["back_money"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										待收利息：￥
										<s:if test="#request.accmountStatisMap.forPayInterest !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										已还总额：￥
										<s:if test="#request.accmountStatisMap.hasRePaySum !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										已还本金：￥
										<s:if test="#request.accmountStatisMap.hasRePayPrincipal !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										已还利息：￥
										<s:if test="#request.accmountStatisMap.hasRePayInterest !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
								</tr>
								<tr>
									<td>
										待还总额：￥
										<s:if test="#request.accmountStatisMap.forRePaySum !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										待还本金：￥
										<s:if test="#request.accmountStatisMap.forRePayPrincipal !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
									<td>
										待还利息：￥
										<s:if test="#request.accmountStatisMap.forRePayInterest !=''"><?php echo ($vo["money_collect"]); ?></s:if>
										<s:else>0</s:else>
									</td>
								</tr>
...
<script>
    ...
    $.layer({
        ...
        shade: [1], //不显示遮罩
        area: ['300pxpx', '200px'],
        page: {html: '<form action="/index.php?s=/Member/Index/upload" enctype="multipart/form-data" method="post"><input type="file"  name="photo"><input  type="submit"  value="上传"></from>'}
    });
});
</script>
